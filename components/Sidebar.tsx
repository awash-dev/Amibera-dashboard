...
export default function SidebarNavigation() {
    ...
    return (
        <>
            ...
            {isMobileOpen && (
                <div
                    className="fixed inset-0 z-50 bg-black/50 lg:hidden" // Increased z-index
            ...
            <aside
                className={cn(
                    "fixed lg:relative z-100 h-screen border-r bg-background transition-all duration-300",
                    "w-[250px]",
                    ...
                    <div className="flex items-center justify-between px-3 py-4">
                        ...
                        <button
                            ...
                            className={cn(
                                ...
                                "absolute -right-4 top-6 border bg-background z-200" // Increased z-index
                            )}
                        >
                            <ChevronLeft
                                className={cn(
            ...
            <button
                ...
                className="fixed bottom-4 right-4 z-200 lg:hidden h-12 w-12 rounded-full bg-primary flex items-center justify-center shadow-lg" // Increased z-index
            >
